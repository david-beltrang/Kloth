...
fun FeedScreen(
    ...
    val mockPosts = listOf(
        ...
        PostItem(
            ...
            title = "Ether Fluid Dress",
            rating = "4.5",
            reviewCount = 89,
            comments = "18",
            description = "Effortless luxury designed for the modern muse. This piece flows with every movement, capturing the light in its delicate silk fibers.",
            tags = listOf("whiteout", "silk", "timeless"),
            category = "PRENDA",
