...
/*
Este composable se usa en la pantalla ProfileScreen. Es de tipo tab
...
fun ProfileTabRow(
    ...
    TabRow(
        ...
        Tab(
            ...
            text = {
                Text(
                    text = stringResource(R.string.profile_tab_posts),
        ...
        Tab(
            ...
            text = {
                Text(
                    text = stringResource(R.string.profile_tab_rated),
                    style = MaterialTheme.typography.labelLarge
                )
            }
        )
